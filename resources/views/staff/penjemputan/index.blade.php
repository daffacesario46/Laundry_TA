...
<section class="content-main">
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Data Penjemputan</h2>
            <p>Kelola penjemputan cucian pelanggan</p>
        </div>
    </div>

    <div class="card mb-4">
        <header class="card-header">
            <form action="{{ route('staff.penjemputan.index') }}" method="GET">
                <div class="row gx-3">
                    ...
                    <div class="col-lg-3 col-md-3 mb-3">
                        <select class="form-select" name="status">
                            ...
                            <option value="diproses" {{ request('status') == 'diproses' ? 'selected' : '' }}>Sedang Dijemput</option>
                    ...
                    @if(request()->anyFilled(['search', 'status']))
                        <div class="col-lg-2 col-md-3 mb-3">
                            <a href="{{ route('staff.penjemputan.index') }}" class="btn btn-light w-100">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ Str::limit($item->alamat_jemput, 30) }}</td>
                                <td>
                                    @if($item->hasStaff())
                                        <span class="badge bg-success">{{ $item->getStaffNama() }}</span>
                                    @else
                                ...
                                <td class="text-end">
                                    <a href="{{ route('staff.penjemputan.show', $item->penjemputan_id) }}" 
