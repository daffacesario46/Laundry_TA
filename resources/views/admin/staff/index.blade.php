...
<section class="content-main">
    <div class="content-header">
        <div>
            <h2 class="content-title card-title">Manajemen Staff</h2>
            <p>Kelola data staff laundry</p>
        </div>
        <div>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambahStaff">
                <i class="material-icons md-add"></i> Tambah Staff
            </button>
        </div>
    </div>
            ...
            <form action="{{ route('admin.staff.index') }}" method="GET">
                <div class="row gx-3">
                    ...
                    @if(request()->anyFilled(['search', 'status', 'paginate']))
                        <div class="col-lg-2 col-md-3 mb-3">
                            <a href="{{ route('admin.staff.index') }}" class="btn btn-light w-100">
