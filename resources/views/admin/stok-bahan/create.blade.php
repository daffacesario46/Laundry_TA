                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="jenis_bahan" class="form-select @error('jenis_bahan') is-invalid @enderror" required>
                                    ...
                                    <option value="detergen" {{ old('jenis_bahan') == 'detergen' ? 'selected' : '' }}>Detergen</option>
                                    <option value="pewangi" {{ old('jenis_bahan') == 'pewangi' ? 'selected' : '' }}>Pewangi</option>
                                    <option value="pelembut" {{ old('jenis_bahan') == 'pelembut' ? 'selected' : '' }}>Pelembut</option>
                                    <option value="pemutih" {{ old('jenis_bahan') == 'pemutih' ? 'selected' : '' }}>Pemutih</option>
                                </select>
                                @error('jenis_bahan')
